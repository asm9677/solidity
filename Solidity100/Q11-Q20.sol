...
contract Q11 {
    ...
    */
    ...
    function pushEvenNumber(uint _n) public {
        if(_n % 2 == 0)
            numbers.push(_n);
    }
}
...
contract Q17 {
    ...
    */ 
    ...
    function isBob(string memory _name) public pure returns(bool) {
        return keccak256(abi.encodePacked(_name)) == keccak256("Bob");        
    }
}
...
contract Q19 {
    ...
    */ 
    ...
    function getDouble(uint _n) public pure returns(uint) {
        require(_n < 1000, "over 1000");
        return _n*2;
    }
}
