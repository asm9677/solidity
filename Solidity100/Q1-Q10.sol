...
contract Q3 {
    ...
    */ 
    ...
    function pow3(uint _a) public pure returns(uint) {
        return _a ** 3;
    }
}
...
contract Q5 {
    ...
    */ 
    ...
    function calc(uint _n) public pure returns(uint) {        
        if(_n == 0)
            return 0;
        else if(_n <= 3)
            return _n ** 2;
...
contract Q8 {
    ...
    */ 
    ...
    function pushNumbers(uint _score) public pure returns(string memory) {
        if(_score == 0)
            return "";
        else if(_score <= 10)
            return "A";
...
contract Q10 {
    ...
    */
    ...
    function getNumbr(uint _n) public view returns(uint) {
        return numbers[_n-1];
    }
}
